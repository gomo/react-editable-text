...
function (_Editable) {
  ...
  _createClass(EditableBox, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
      ...
      }, this.getChildDom(this.props, 'label')), _react["default"].createElement("div", {
        className: "buttons"
      }, function () {
        if (_this.state.editable) {
          ...
          }, _this.getChildDom(_this.props, 'cancelLabel')), "\xA0", _react["default"].createElement("button", {
        ...
        ref: "element",
        className: (0, _classnames["default"])('form-control', this.props.formElemClass),
